...
summary(fit.three.full.ml)
fitMeasures(fit.three.full.ml)
...
summary(fit.three.full.dwls)
fitMeasures(fit.three.full.dwls)
...
summary(fit.three.indep.ml)
fitMeasures(fit.three.indep.ml)
...
summary(fit.three.indep.dwls)
fitMeasures(fit.three.indep.dwls)
...
summary(fit.one.dwls)
fitMeasures(fit.one.dwls)
...
summary(fit.shft.inhb.ml)
fitMeasures(fit.shft.inhb.ml)
...
summary(fit.shft.inhb.dwls)
fitMeasures(fit.shft.inhb.dwls)
...
summary(fit.shft.updt.ml)
fitMeasures(fit.shft.updt.ml)
...
summary(fit.shft.updt.dwls)
fitMeasures(fit.shft.updt.dwls)
...
summary(fit.updt.inhb.ml)
fitMeasures(fit.updt.inhb.ml)
...
summary(fit.updt.inhb.dwls)
fitMeasures(fit.updt.inhb.dwls)
